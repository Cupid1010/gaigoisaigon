...
class PolicyCotroller {
  ...
  //  [GET]  / policy/bookguide
  async downTeleguide(req, res) {
    
    res.render('policy/sizeguide',{pageTitle:`Hướng dẫn tải Telegram - ${process.env.DOMAINNAME}`},)
    
  }
  //  [GET]  / policy/bookguide
  async bookguide(req, res) {
    
    res.render('policy/orderguide',{pageTitle:`Hướng dẫn book gái - ${process.env.DOMAINNAME}`},)
